...
import { DAILY_SPECIALS } from '../data/bakeryData';
  ...
  return (
    <section id="specials" className="py-16 sm:py-20 bg-[#FDFBF7] border-b border-stone-200 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Day Selector Tabs */}
        <ScrollFloat delay={0.2} direction="up" distance={20} className="flex items-center justify-center gap-2 overflow-x-auto pb-4 mb-8">
        ...
        <ScrollFloat delay={0.3} direction="up" distance={30} floatOnHover className="mb-12">
          <div className="bg-white rounded-2xl border border-stone-200 shadow-2xs overflow-hidden p-6 sm:p-8">
        ...
        <ScrollFloat delay={0.4} direction="up" distance={30}>
